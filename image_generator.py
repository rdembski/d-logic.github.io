...
DESCRIPTION = """## IMAGE GENERATOR 4K StableDiffusionXL

"""

if not torch.cuda.is_available():
    DESCRIPTION += "\n<p style='color: black;'>⚠️Running on CPU, this may not work on CPU.</p>"
...
def image_generator_demo2():
    with gr.Blocks(css=css, theme="bethecloud/storj_theme") as demo:
        ...
        gr.Markdown("""
        **Disclaimer:** This is the demo space for generating images using Stable Diffusion with grids, filters, templates, quality styles, and types.
        """)
